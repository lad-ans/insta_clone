      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: "Actualizar nome de visualização",
            errorText: _displayNameValid
                ? null
                : "Nome de visualização demasiado curto",
          ),
        )
      ],
    );
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: "Actualizar a biografia",
            errorText: _bioValid ? null : "Biografia muito longa",
          ),
        )
      ],
    );
